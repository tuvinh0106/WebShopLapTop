    ...
    <script>
        ...
        $(document).on('click', '.clicksanpham', function() {
            ...
            if (tieude == 'xoa') {
                ...
                $('#hinhSanPhamLap').attr('required', false);
                ...
                success: function(res) {
                    if (res.status == 200) {
                        ...
                        if (tieude == 'xoa' || tieude == 'suagia') {
                            ...
                            $('#hidden_id').val(res.data.masanpham);
                            $('#tenSanPhamLap').val(res.data.tensanpham);
                            $('#baoHanhLap').val(res.data.baohanh);
                            $('#hangSanXuatLap').val(res.data.mahang);
                            $('#moTaLap').val(res.data.mota);
