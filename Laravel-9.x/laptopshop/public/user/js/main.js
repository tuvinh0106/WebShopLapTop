...
(function($) {
    ...
    $('#ship-box').on('click', function() {
        ...
        if ($(this).is(":checked")) {
            $('#hotenNguoiNhan').attr('required', true);
            $('#diachiNguoiNhan').attr('required', true);
            $('#sodienthoaiNguoiNhan').attr('required', true);
        } else {
            $('#hotenNguoiNhan').attr('required', false);
            $('#diachiNguoiNhan').attr('required', false);
            $('#sodienthoaiNguoiNhan').attr('required', false);
        }
    });
    /*----------------------------------------*/
    /* 15. Li's Blog Gallery Slider
