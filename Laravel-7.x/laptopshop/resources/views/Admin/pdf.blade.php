        ...
        <div class="row">
            ...
            <div class="col-xs-4" style="text-align: center;">
                <img width="215" height="75"
                    src="{{ asset('user/images/menu/logo/1.jpg') }}" />
                <img width="120" height="100" title="test" src="data:image/png;base64, {!! base64_encode(QrCode::generate( $loai == 'PN' ? 'PN'.$phieupdf->maphieunhap :'PX' . $phieupdf->maphieuxuat)) !!}" />
            </div>
        </div>
