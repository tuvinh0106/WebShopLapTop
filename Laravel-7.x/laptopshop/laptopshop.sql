...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 28, 2022 lúc 07:24 AM
...
(61, 3, 28, 200, 599000),
(62, 3, 29, 200, 499000),
(63, 4, 21, 300, 12000000),
(64, 4, 22, 300, 11000000);
...
(13, 'Vi Tính QV', '0123456788', 'TpHCM', 0, 1, NULL, NULL, '2022-12-28 13:16:51');
...
(3, 11, 'cập nhật lần 2', 359400000, 0, '2022-12-23 09:13:41'),
(4, 13, 'cập nhật lần 1', 6900000000, 0, '2022-12-28 13:20:38');
...
(21, 'Laptop HP Pavilion 14 dv2036TU', 12, 'Thiết kế cá tính, siêu nhỏ gọn, màn hình tuyệt đẹp và trên hết là cấu hình cực mạnh từ bộ vi xử lý Intel thế hệ thứ 12 mới nhất, HP Pavilion 14 dv2036TU luôn sát cánh bên bạn để hoàn thành công việc nhanh chóng.', 300, 12000000, 13000000, 0, 22, 4, 18, 18, NULL, 0, 0, '2022-12-22 20:03:39'),
(22, 'Laptop MSI Modern 15 A5M 234VN', 12, 'Tập hợp những công nghệ mới nhất trong một thiết kế thời thượng, MSI Modern 15 A5M 234VN tự tin hỗ trợ tối đa cho công việc của bạn, đồng thời thể hiện cá tính riêng biệt.', 300, 11000000, 12000000, 0, 23, 5, 19, 19, NULL, 0, 0, '2022-12-22 20:04:31'),
...
(27, 'Tai nghe On-ear Logitech H370 (Đen)', 12, 'Thưởng thức các cuộc gọi internet trong trẻo cho cảm giác như bạn đang nói chuyện trực tiếp. Việc chơi game trở nên đẳng cấp với các thao tác và hiệu ứng thú vị. Và nghe nhạc vượt ra ngoài các giai điệu và đoạn điệp khúc để hội tụ âm điệu đầy đủ.', 200, 699000, 799000, 0, 28, 7, NULL, NULL, 9, 1, 0, '2022-12-22 20:40:34'),
(28, 'Chuột gaming Logitech G102 Gen2 Lightsync', 12, 'Chuột gaming Logitech G102 Gen2 Lightsync có một thiết kế hiện đại, cao cấp. Sở hữu công nghệ LIGHTSYNC, cảm biến DPI cao và 6 nút tiện lợi giúp bạn dễ dàng sử dụng làm việc và chơi game hơn.', 200, 599000, 699000, 0, 29, 7, NULL, NULL, 10, 1, 0, '2022-12-22 20:41:01'),
(29, 'Chuột gaming không dây Logitech G304 (Trắng)', 12, 'Chuột là thiết bị ngoại vi không thể thiếu cho mỗi bộ máy tính PC hay laptop của bạn để sử dụng hằng ngày. Chuột gaming không dây Logitech G304 (Trắng) sẽ là lựa chọn không thể bỏ qua dành cho bạn khi sử dụng hằng ngay. Hãy cùng Phong Vũ đi tìm hiểu chi tiết chuột Logitech G304 này nhé!', 200, 499000, 599000, 0, 30, 7, NULL, NULL, 11, 1, 0, '2022-12-22 20:41:33');
...
--
ALTER TABLE `chitietphieunhap`
  MODIFY `machitietphieunhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
